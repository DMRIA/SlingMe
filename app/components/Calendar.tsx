    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 text-white hover:bg-white/10 rounded-full transition-all"
                ),
                ...
                day: cn(
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-primary hover:text-white rounded-md transition-all text-gray-300"
                ),
                ...
                day_outside:
                    "day-outside text-gray-700 opacity-50 aria-selected:bg-white/5 aria-selected:text-gray-500 aria-selected:opacity-30",
